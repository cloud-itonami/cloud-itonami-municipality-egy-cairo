# cloud-itonami-municipality-egy-cairo

Municipal-ordinance compliance catalog for **Cairo** — the
THIRTY-SIXTH municipality-level entry alongside
...
Cairo is the axis's first North African entry.

## Sourcing note

Egypt's "New Capital" (formerly New Administrative Capital,
inaugurated as the seat of government in April 2024, with the
Cabinet, House of Representatives, and Central Bank already relocated
there) is undergoing an active, unresolved transition; as of this
tick a February 2026 draft law proposing "special status" for the New
Capital (and a possible rename to "Memphis") remains pending, and
Wikidata's own P36 (capital) property for Egypt still lists Cairo —
this catalog follows that current Wikidata designation and documents
the ongoing ambiguity transparently rather than guessing which way it
will resolve.

## Scope

A **read-only reference/archive** catalog — not an Advisor⊣Governor
actuation actor. It proposes or executes nothing on Cairo
Governorate's behalf.
...
Both entries directly confirmed: **Law No. 43 of 1979** (Local
Government System Law, 20 June 1979, via lawyeregypt.net) and
**Law No. 187 of 2023** (Building Violations Reconciliation Law,
year-only date, via blogs.realestate.gov.eg, an official Egyptian
government domain).
...
festivals and heritage sites for Cairo:
...
itself remains Cairo Governorate's; this repo stores only citation
